...
#this script only plot the simulated Cas9 targets
...
allele_table_cas9 = pd.read_csv('/data1/home/gdpeng/chengchen/dualproject/sample293Tv2/T293_cas9_target_simulation_allele_table.csv',
                           usecols = ['cellBC', 'intBC', 'r3', 'r4', 'allele', 'lineageGrp', 'readCount', 'UMI'])
                           

# #function may be required for next step
# def get_default_cut_site_columns(allele_table_cas9):
...
#     cut_sites = [
#         column
#         for column in allele_table_cas9.columns
...
#indel_priors = cas.pp.compute_empirical_indel_priors(allele_table_cas9, grouping_variables=['intBC', 'lineageGrp'])
indel_priors = pd.read_csv("/data1/home/gdpeng/chengchen/dualproject/sample293Tv2/sc293T_indel_priors.csv", index_col=0)

character_matrix, priors, state_2_indel = cas.pp.convert_alleletable_to_character_matrix(allele_table_cas9,
...
#save newick files
f = open("/data1/home/gdpeng/chengchen/dualproject/sample293Tv2/newick_trees/tree_cas9target.newick", 'w')
f.write(cas_tree.get_newick())
f.close()

#save tree figures
figure = cas.pl.plot_matplotlib(cas_tree, add_root=True)[0]
figure.savefig("/data1/home/gdpeng/chengchen/dualproject/sample293Tv2/figures/tree_cas9target.pdf")
