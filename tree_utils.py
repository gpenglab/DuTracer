...
def extend_dummy_branches(G, max_depth):
    """
    Converts the tree to an h by adding in dummy nodes and branches &
    ...
    for n in leaves:
        ...
        while G.nodes[n]["depth"] < max_depth:
            ...
            d = G.nodes[n]["depth"]
            new_node = 'state-node_'+str(d)+'_'+n
            ...
            G.nodes[new_node]['character_states'] = G.nodes[n]["character_states"]
            G.nodes[new_node]['time'] = 0
